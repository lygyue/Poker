...
// Adapted from Matrix math by Wild Magic http://www.geometrictools.com/
        ...
        Vector3& kD, Vector3& kU) const
    {
		...
		if (!RealEqual(fInvLength,0)) fInvLength = InvSqrt(fInvLength);
        ...
        Radian& rfRAngle) const
    {
        ...
        if ( rfPAngle < Radian(HALF_PI) )
        {
            ...
            else
            {
                ...
                Radian fRmY = Radian(atan2(m[1][0],m[1][1]));
        ...
        {
            // WARNING.  Not a unique solution.
            Radian fRpY = Radian(atan2(m[1][0],m[1][1]));
            rfRAngle = Radian(0.0);  // any angle works
        ...
        Radian& rfRAngle) const
    {
        ...
        rfPAngle = Radian(asin(-m[0][1]));
        if ( rfPAngle < Radian(HALF_PI) )
        {
            if ( rfPAngle > Radian(-HALF_PI) )
            {
                rfYAngle = Radian(atan2(m[2][1],m[1][1]));
                rfRAngle = Radian(atan2(m[0][2],m[0][0]));
                return true;
            }
            else
            {
                // WARNING.  Not a unique solution.
                Radian fRmY = Radian(atan2(-m[2][0],m[2][2]));
                rfRAngle = Radian(0.0);  // any angle works
                rfYAngle = rfRAngle - fRmY;
                return false;
            }
        ...
        {
            // WARNING.  Not a unique solution.
            Radian fRpY = Radian(atan2(-m[2][0],m[2][2]));
            rfRAngle = Radian(0.0);  // any angle works
            rfYAngle = fRpY - rfRAngle;
            return false;
        }
        ...
        Radian& rfRAngle) const
    {
        ...
        rfPAngle = Radian(asin(-m[1][2]));
        if ( rfPAngle < Radian(HALF_PI) )
        {
            if ( rfPAngle > Radian(-HALF_PI) )
            {
                rfYAngle = Radian(atan2(m[0][2],m[2][2]));
                rfRAngle = Radian(atan2(m[1][0],m[1][1]));
                return true;
            }
            else
            {
                // WARNING.  Not a unique solution.
                Radian fRmY = Radian(atan2(-m[0][1],m[0][0]));
                rfRAngle = Radian(0.0);  // any angle works
                rfYAngle = rfRAngle - fRmY;
                return false;
            }
        ...
        {
            // WARNING.  Not a unique solution.
            Radian fRpY = Radian(atan2(-m[0][1],m[0][0]));
            rfRAngle = Radian(0.0);  // any angle works
            rfYAngle = fRpY - rfRAngle;
            return false;
        }
        ...
        Radian& rfRAngle) const
    {
        ...
        rfPAngle = Radian(asin(m[1][0]));
        if ( rfPAngle < Radian(HALF_PI) )
        {
            if ( rfPAngle > Radian(-HALF_PI) )
            {
                rfYAngle = Radian(atan2(-m[2][0],m[0][0]));
                rfRAngle = Radian(atan2(-m[1][2],m[1][1]));
                return true;
            }
            else
            {
                // WARNING.  Not a unique solution.
                Radian fRmY = Radian(atan2(m[2][1],m[2][2]));
                rfRAngle = Radian(0.0);  // any angle works
                rfYAngle = rfRAngle - fRmY;
                return false;
            }
        ...
        {
            // WARNING.  Not a unique solution.
            Radian fRpY = Radian(atan2(m[2][1],m[2][2]));
            rfRAngle = Radian(0.0);  // any angle works
            rfYAngle = fRpY - rfRAngle;
            return false;
        }
        ...
        Radian& rfRAngle) const
    {
        ...
        rfPAngle = Radian(asin(m[2][1]));
        if ( rfPAngle < Radian(HALF_PI) )
        {
            if ( rfPAngle > Radian(-HALF_PI) )
            {
                rfYAngle = Radian(atan2(-m[0][1],m[1][1]));
                rfRAngle = Radian(atan2(-m[2][0],m[2][2]));
                return true;
            }
            else
            {
                // WARNING.  Not a unique solution.
                Radian fRmY = Radian(atan2(m[0][2],m[0][0]));
                rfRAngle = Radian(0.0);  // any angle works
                rfYAngle = rfRAngle - fRmY;
                return false;
            }
        ...
        {
            // WARNING.  Not a unique solution.
            Radian fRpY = Radian(atan2(m[0][2],m[0][0]));
            rfRAngle = Radian(0.0);  // any angle works
            rfYAngle = fRpY - rfRAngle;
            return false;
        }
        ...
        Radian& rfRAngle) const
    {
        ...
        rfPAngle = Radian(asin(-m[2][0]));
        if ( rfPAngle < Radian(HALF_PI) )
        {
            if ( rfPAngle > Radian(-HALF_PI) )
            {
                rfYAngle = Radian(atan2(m[1][0],m[0][0]));
                rfRAngle = Radian(atan2(m[2][1],m[2][2]));
                return true;
            }
            else
            {
                // WARNING.  Not a unique solution.
                Radian fRmY = Radian(atan2(-m[0][1],m[0][2]));
                rfRAngle = Radian(0.0);  // any angle works
                rfYAngle = rfRAngle - fRmY;
                return false;
            }
        ...
        {
            // WARNING.  Not a unique solution.
            Radian fRpY = Radian(atan2(-m[0][1],m[0][2]));
            rfRAngle = Radian(0.0);  // any angle works
            rfYAngle = fRpY - rfRAngle;
            return false;
        }
